...
const ticker = ['grid tactics', 'P2P sync', 'AI opponent', 'fog of war', 'base building']

export function Hero() {
  return (
    <section id="top" className="bg-grid relative overflow-hidden border-b border-border">
      <div className="mx-auto max-w-6xl px-6 py-20 md:py-32">
        <div className="mb-8 flex flex-wrap gap-2" aria-label="Game concept tags">
          {ticker.map((t) => (
            <span
              key={t}
        ...
        <p className="mb-10 max-w-2xl text-pretty text-lg leading-relaxed text-muted-foreground md:text-xl">
          A prototype 2D real-time strategy with P2P multiplayer via PeerJS and an AI opponent.
          Grid-based tactics on a calculator battlefield — no RNG, no speed-clicking, pure
          system design and match simulation.
        </p>
